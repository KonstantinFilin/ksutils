...
require_once realpath(dirname(__FILE__) . "/../../../../src/KsUtils") . "/Validator/Int.php";
...
class IntTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers KsUtils\Validator\Int::__construct()
     * @covers KsUtils\Validator\Int::hasError()
     */
    public function testCheckDefault()
    {
        ...
        $this->assertEquals(
            "Must be a number between 1 and 1000000, checked value: -12",
            $this->objectPos->getError()
        );
    }
