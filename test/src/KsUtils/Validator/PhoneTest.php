...
require_once realpath(dirname(__FILE__) . "/../../../../src/KsUtils") . "/Validator/Phone.php";
...
class PhoneTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers KsUtils\Validator\Phone::__construct()
     * @covers KsUtils\Validator\Phone::hasError()
     */
    public function testCheck()
    {
        ...
        $this->assertFalse($this->object->check("12345"));
