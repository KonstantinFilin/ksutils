...
require_once realpath(dirname(__FILE__) . "/../../../../src/KsUtils") . "/Validator/StrLenRange.php";
...
class StrLenRangeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers KsUtils\Validator\StrLenRange::__construct()
     * @covers KsUtils\Validator\StrLenRange::hasError()
     */
